...
-- All existing data is backfilled to 'default' tenant.
...
UPDATE crm_people SET tenant_id = 'default' WHERE tenant_id IS NULL;
...
UPDATE crm_companies SET tenant_id = 'default' WHERE tenant_id IS NULL;
...
UPDATE crm_notes SET tenant_id = 'default' WHERE tenant_id IS NULL;
...
UPDATE crm_tasks SET tenant_id = 'default' WHERE tenant_id IS NULL;
...
UPDATE crm_task_history SET tenant_id = 'default' WHERE tenant_id IS NULL;
...
UPDATE crm_routines SET tenant_id = 'default' WHERE tenant_id IS NULL;
...
UPDATE crm_conversations SET tenant_id = 'default' WHERE tenant_id IS NULL;
...
UPDATE crm_messages SET tenant_id = 'default' WHERE tenant_id IS NULL;
