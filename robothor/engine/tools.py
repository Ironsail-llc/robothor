...
class ToolRegistry:
    ...
    def _register_all(self) -> None:
        ...
        self._schemas["gws_gmail_search"] = {
            "type": "function",
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "query": {
                            "type": "string",
                            "description": "Gmail search query (same syntax as Gmail search box, e.g. 'is:unread from:alice newer_than:1d')",
                        },
                        "max_results": {
                            "type": "integer",
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "message_id": {
                            "type": "string",
                            "description": "Gmail message ID (from gws_gmail_search results)",
                        },
                        "thread_id": {
                            "type": "string",
                            "description": "Gmail thread ID (returns all messages in thread). Use either message_id or thread_id.",
                        },
                        "format": {
                            "type": "string",
                            "description": "Response format: 'full' (headers+body), 'metadata' (headers only), 'minimal' (IDs only)",
                            "default": "full",
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "thread_id": {
                            "type": "string",
                            "description": "Thread ID to reply to (makes this a reply instead of new email)",
                        },
                        "in_reply_to": {
                            "type": "string",
        ...
        self._schemas["gws_gmail_modify"] = {
            "type": "function",
            "function": {
        ...
        self._schemas["gws_calendar_list"] = {
            "type": "function",
            "function": {
                "name": "gws_calendar_list",
                "description": "List calendar events in a date range. Returns structured event data (title, time, attendees, location).",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "time_min": {
                            "type": "string",
                            "description": "Start of range in RFC3339 format (e.g. '2026-03-06T00:00:00Z')",
                        },
                        "time_max": {
                            "type": "string",
                            "description": "End of range in RFC3339 format",
                        },
                        "max_results": {
                            "type": "integer",
        ...
        self._schemas["gws_calendar_create"] = {
            "type": "function",
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "start": {
                            "type": "string",
                            "description": "Start time in RFC3339 format (e.g. '2026-03-07T14:00:00-05:00')",
                        },
                        "end": {
                            "type": "string",
        ...
        self._schemas["gws_calendar_delete"] = {
            "type": "function",
            "function": {
...
def _handle_sync_tool(
    ...
    *,
    ...
    if name in GWS_TOOLS:
        return _handle_gws_tool(name, args)
...
# ─── Google Workspace (gws CLI) handlers ─────────────────────────────
