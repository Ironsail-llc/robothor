...
- **Business Adapters** — External MCP servers configured in `~/.config/robothor/adapters/` provide additional tools (healthcare, ERP, etc.) dynamically discovered at agent startup
