/**
 * Shared Robothor brand styles — oklch palette matching the Helm (app.robothor.ai).
 *
 * Usage: const { brandVars, brandBase } = require('../shared/brand-styles');
 * Then inject `brandVars() + brandBase()` into your <style> block.
 */
...
module.exports = { brandVars, brandBase };
